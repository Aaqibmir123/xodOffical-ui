...
export default function WhyChooseUs() {
  return (
    <section className="bg-zinc-900 text-white py-20 border-y border-zinc-800">
      <ScrollReveal className="max-w-7xl mx-auto px-4 md:px-12 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 w-full lg:w-auto text-center">
          <div className="hover-lift bg-zinc-950/50 p-6 rounded-xl border border-zinc-800 hover:border-amber-400/50">
