...
export default function Footer() {
  return (
    <footer
      id="contact"
      className="bg-[#0f0f0f] text-zinc-400 text-sm border-t border-zinc-800 pt-16 pb-8"
    >
      <ScrollReveal className="max-w-7xl mx-auto px-4 md:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          ...
          <p className="text-xs text-zinc-400 leading-relaxed mb-6">
            Canada's leading dispatch service provider offering complete
            dispatch solutions for Amazon & Non Amazon loads.
          </p>
        </div>
      ...
      {/* Bottom Footer */}
      <div className="max-w-7xl mx-auto px-4 md:px-12 pt-6 border-t border-zinc-900 text-center space-y-2">
        <p className="text-xs text-zinc-500">
          © 2026 XCDGOC PVT LTD - Extreme Canada Dispatch Group Of Companies.
          All Rights Reserved.
        </p>
